...
function updateModelParameters() {
    ...
    if (modelType === "dqn") {
        modelParametersDiv.innerHTML = `
            ...
            <label for="epsilon_min">Epsilon Min:</label>
            <input type="number" step="0.01" id="epsilon_min" name="parameters[epsilon_min]" value="0.01" required>
            <br>

            <label for="replay_buffer_size">Replay Buffer Size:</label>
            <input type="number" id="replay_buffer_size" name="parameters[replay_buffer_size]" value="100000" required>
            <br>

            <label for="max_steps">Max Steps per Episode:</label>
            <input type="number" id="max_steps" name="parameters[max_steps]" value="100" required>
            <br>
        `;
    } 
    else if (modelType === "double_dqn") {
        modelParametersDiv.innerHTML = `
            <label for="num_episodes">Number of Episodes:</label>
            <input type="number" id="num_episodes" name="parameters[num_episodes]" value="500" required>
            <br>
            ...
            <label for="learning_rate">Learning Rate:</label>
            <input type="number" step="0.0001" id="learning_rate" name="parameters[learning_rate]" value="0.0005" required>
            <br>
            ...
            <label for="tau">Soft Update Tau:</label>
            <input type="number" step="0.001" id="tau" name="parameters[tau]" value="0.01" required>
            <br>
...
document.getElementById("train-model-form").onsubmit = async (event) => {
    ...
    if (response.message) {
        ...
        if (metrics) {
            ...
            document.getElementById("training-metrics").style.display = "block";
        }
    } else {
